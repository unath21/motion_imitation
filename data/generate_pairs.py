...
def main():
    ...
    ap.add_argument('--val-pairs', type=int, default=100)
    ap.add_argument('--delta-min', type=int, default=2)
    ap.add_argument('--delta-max', type=int, default=6)
    ap.add_argument('--seed', type=int, default=42)
    ap.add_argument('--action-list', nargs='+', default=['squat', 'pushup'], help='List of actions to include')
