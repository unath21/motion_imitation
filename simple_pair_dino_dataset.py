...
class SimplePairDINODataset(Dataset):
    ...
    def _load_dino_features(self, video_id: str, frame_file: str):
        """Load DINO features for a single frame from disk"""
    ...
    def __getitem__(self, idx):
        ...
        dino1 = self._load_dino_features(vid, f1)
        dino2 = self._load_dino_features(vid, f2)
